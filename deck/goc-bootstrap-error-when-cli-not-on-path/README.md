---
title: goc-bootstrap-error-when-cli-not-on-path
...
Sub-card of `goc-ship-game-of-cards-as-cross-agent-cli`. This is a small UX detail with disproportionate value: it's the difference between a new user landing on a clear next step ("install this with one command") vs. landing on a Python traceback they have to decode.
