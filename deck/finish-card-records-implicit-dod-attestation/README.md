---
title: finish-card-records-implicit-dod-attestation
summary: |-
...
# finish-card-records-implicit-dod-attestation
...
- Spawned by: May 3 user discussion on DoD layers
  (companion card: [`rename-blocks-to-advances-and-design-value-sort`](../rename-blocks-to-advances-and-design-value-sort/)).
