# Log — goc-finish-card-records-implicit-dod-attestation
...
[`goc-rename-blocks-to-advances-and-design-value-sort`](../goc-rename-blocks-to-advances-and-design-value-sort/).
