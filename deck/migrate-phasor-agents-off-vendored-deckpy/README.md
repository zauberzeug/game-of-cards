---
title: migrate-phasor-agents-off-vendored-deckpy
...
Sub-card of `ship-game-of-cards-as-cross-agent-cli`. This is the **dogfood card** — the one that proves the whole epic works in production by running it on the most demanding GoC repo there is (this one).
