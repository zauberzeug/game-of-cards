# Log — goc-rename-blocks-to-advances-and-design-value-sort
...
[`goc-finish-card-records-implicit-dod-attestation`](../goc-finish-card-records-implicit-dod-attestation/).
...
**Follow-up filed**: [`goc-populate-advances-graph-deeper-pass`](../goc-populate-advances-graph-deeper-pass/)
