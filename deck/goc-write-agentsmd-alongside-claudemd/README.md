---
title: goc-write-agentsmd-alongside-claudemd
...
Sub-card of `goc-ship-game-of-cards-as-cross-agent-cli`. The methodology framework's reach extends as far as agents read its guidance file — and CLAUDE.md is read by exactly one agent.
...
- Sibling install card: `goc-install-command-scaffolds-repo` (consumes the AGENTS.md template alongside the CLAUDE.md template)
