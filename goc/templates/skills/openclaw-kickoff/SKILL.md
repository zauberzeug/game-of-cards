...
hunting for a Claude Code-style analog:

> **No permission grant required.** Claude Code gates `Bash(goc:*)`
...
>
> **No host-specific private-notes file.** Claude Code conventions
> include `CLAUDE.local.md` for project-local notes Claude reads but
