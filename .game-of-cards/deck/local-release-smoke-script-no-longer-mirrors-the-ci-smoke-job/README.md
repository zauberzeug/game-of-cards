...
| Path A `--allowedTools` | `Read,Write,Edit,Bash,Skill(kickoff),Skill(audit-deck)` (`release.yml:540`) | `Read,Write,Edit,Bash(cd:*),Bash(ls:*),Bash(pwd:*),Bash(goc:*),Bash(git:*),Bash(which:*),Skill(kickoff),Skill(audit-deck)` (`smoke_release.sh:94`) |
