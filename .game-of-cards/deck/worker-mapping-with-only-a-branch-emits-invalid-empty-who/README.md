...
`goc/engine.py:455-463` — `_emit_worker`:
...
(`goc/engine.py:1986-1989`) rejects:
...
- `goc decide` (`_cmd_decide`, engine.py:6885)
...
- `goc migrate-list-style` (`_cmd_migrate_list_style`, engine.py:7235)
