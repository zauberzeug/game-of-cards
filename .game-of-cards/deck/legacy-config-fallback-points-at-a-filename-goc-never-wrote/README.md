...
- `goc/engine.py:5378` — consumption: `for path in (GAME_OF_CARDS_CONFIG_FILE, LEGACY_DECK_CONFIG_FILE):`
- `goc/install.py:1088` — the upgrade migration's contrasting (correct)
...
(`goc/install.py:1088`). The migration is right; the fallback has been
