...
- `goc/engine.py:5381` — consumption: `for path in (GAME_OF_CARDS_CONFIG_FILE, LEGACY_DECK_CONFIG_FILE):`
- `goc/install.py:1302` — the upgrade migration's contrasting (correct)
...
(`goc/install.py:1302`). The migration is right; the fallback has been
