...
definition_of_done: |
  ...
  - [ ] MECHANICAL: whichever of the exit-code / success-line options the decision picks is implemented consistently across all seven call sites (`engine.py:6018, 5763, 5959, 6216, 6238, 6253, 6582`), rather than in `_cmd_publish` alone.
