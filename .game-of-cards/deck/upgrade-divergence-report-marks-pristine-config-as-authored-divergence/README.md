...
- `goc/install.py:1218-1230` — `_classify_user_owned_file` (raw byte compare).
- `goc/install.py:1857` and `goc/install.py:2104` — `goc install` calls
...
`skills_source: <value>` into config.yaml (`install.py:1857`/`:1780`),
