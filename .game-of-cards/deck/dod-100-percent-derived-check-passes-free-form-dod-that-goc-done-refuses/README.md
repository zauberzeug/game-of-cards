...
- `goc/engine.py:5643-5648` — `_run_derived_check("dod-100-percent", ...)`
...
1. **Attest reports SKIPPED.** Change `_run_derived_check` so
   ...
   (see `engine.py:5726-5728`). `Attestation OK` stays correct
...
- Options 1 and 2 edit only `_run_derived_check` (`engine.py:5643-5648`)
