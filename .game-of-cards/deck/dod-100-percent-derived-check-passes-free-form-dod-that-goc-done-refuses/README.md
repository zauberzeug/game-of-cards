...
- `goc/engine.py:5646-5651` — `_run_derived_check("dod-100-percent", ...)`
...
1. **Attest reports SKIPPED.** Change `_run_derived_check` so
   ...
   (see `engine.py:5729-5731`). `Attestation OK` stays correct
...
- Options 1 and 2 edit only `_run_derived_check` (`engine.py:5646-5651`)
