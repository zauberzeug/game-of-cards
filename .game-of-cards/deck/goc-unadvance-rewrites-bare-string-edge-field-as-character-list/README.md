...
definition_of_done: |
  ...
  - [ ] MECHANICAL: chosen guard / coercion lands at engine.py:6269 (or upstream in parse_frontmatter, per the decision above)
...
The only caller is `_mutate_pair(..., add=False)` at `engine.py:6287`, which
