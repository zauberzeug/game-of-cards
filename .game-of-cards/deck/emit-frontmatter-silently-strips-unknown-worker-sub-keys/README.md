...
- Emitter: `goc/engine.py:440-464` (`_emit_worker`).
- Validator: `goc/engine.py:1980-1997` (`validate_card`, worker branch).
- Reachable from any full-emit verb that calls `emit_frontmatter(fm, body=body)`
  — e.g. `goc wait` at `goc/engine.py:4366`, `goc decide` at `goc/engine.py:6885`,
  `goc migrate-list-style` at `goc/engine.py:7235`, `goc move` at
