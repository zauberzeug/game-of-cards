...
definition_of_done: |
  ...
  - [ ] MECHANICAL: `engine.py:2339-2340` rewritten to read `goc unadvance <child> --by <card>` then `goc advance <card> --by <child>` (arguments un-swapped).
...
The fix is a one-line text rewrite at `engine.py:2339-2340`. The
