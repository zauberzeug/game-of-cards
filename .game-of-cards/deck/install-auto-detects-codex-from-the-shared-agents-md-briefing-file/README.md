...
- `goc/install.py:453` — `_detect_agent_surfaces` (consumes the table)
- `goc/install.py:1810` — install default flow: `detected_agents = _detect_agent_surfaces(target, ...)`
...
for that one context (`goc/install.py:1802`):
