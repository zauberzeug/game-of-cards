...
- `goc/engine.py:6278-6291` — `_mutate_pair` (calls it via `--apply`, `advance`, `new`, `superseded --by`).
...
half-edge for it (`engine.py:2104-2106`):
...
- `goc repair-edges` (dry run) → traceback ending `ValueError: advanced_by: not a list` at `engine.py:6304 → 4911`.
