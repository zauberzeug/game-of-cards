...
definition_of_done: |
  ...
  - [ ] MECHANICAL: the fix lands in `_git_auto_commit` (`goc/engine.py:5019`) so all seven callers inherit it, not per-verb
...
- `goc/engine.py:6070, 5489, 5660, 5917, 5939, 5954, 6283` — the seven
...
card dirs and commit" (`goc/engine.py:5019`) — but no caller, and no
