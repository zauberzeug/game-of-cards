...
definition_of_done: |
  ...
  - [ ] MECHANICAL: `engine.py:4318` updated to reflect the chosen rule. Every filter the table renderer honors must reach `render_board` (or be explicitly documented as out-of-scope in `--board`'s help text).
