...
definition_of_done: |
  ...
  - [ ] MECHANICAL: the fix lands in `goc/install.py:1751` (`_append_precommit_hook`).
...
`goc/install.py:1751` — `_append_precommit_hook`.
