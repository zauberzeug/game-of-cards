...
definition_of_done: |
  ...
  - [ ] MECHANICAL: the fix lands in `goc/install.py:2010` (`_append_precommit_hook`).
...
`goc/install.py:2010` — `_append_precommit_hook`.
