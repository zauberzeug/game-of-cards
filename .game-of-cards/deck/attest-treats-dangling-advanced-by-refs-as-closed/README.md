...
`goc/engine.py:5624-5642` — `_run_derived_check` for the
...
Contrast `validate_supersedes_targets` at `engine.py:2044-2053`,
...
generic dangling-ref error from `validate_card` at `engine.py:1994`
