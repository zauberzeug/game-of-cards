...
definition_of_done: |
  ...
  - [ ] MECHANICAL: `_auto_populate_worker` docstring at `goc/engine.py:5893` updated to match the chosen behavior.
...
The function's own docstring at `goc/engine.py:5894-5899` codifies
the intent:
...
Triggered from `_cmd_status` at `goc/engine.py:5957` on every
