...
- `openclaw-plugin/skills/kickoff/SKILL.md:143` — "the **the agent**-specific"
...
openclaw-plugin/skills/kickoff/SKILL.md:143:> instructions plus, when CLAUDE.md is the home, the the agent-specific
