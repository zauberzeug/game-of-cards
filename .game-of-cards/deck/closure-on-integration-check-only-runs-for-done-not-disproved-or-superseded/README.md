...
definition_of_done: |
  ...
  - [ ] MECHANICAL: docstring at `goc/engine.py:4816` and kickoff doc at `goc/templates/skills/kickoff/reference.md:72-74` updated to match the chosen scope
...
- `goc/engine.py:4816-4822` — helper docstring framing.
